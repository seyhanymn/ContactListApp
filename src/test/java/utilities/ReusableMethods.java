...
import pages.US06.SchoolPage06;
...
public class ReusableMethods {
  ...
  static SchoolPage06 schoolPage06Obj = new SchoolPage06();
...
//        Actions actions = new Actions(driver);
    ...
    public static void signInDean() {
        // Kullanici "schoolUrl" gider
        //Driver.getDriver().get(ConfigReader.getProperty("schoolUrl"));
        // Kullanici Dean kullanici hesabiyla login butonuna tiklar
        schoolPage06Obj.loginButton.click();
        // Kullanici User Name  bolumune geçerli bir deger girer
        schoolPage06Obj.usernameTextBox.sendKeys(ConfigReader.getProperty("dean_username"));
        // Kullanici Password bolumune gecerli sifre girer
        schoolPage06Obj.passwordTextBox.sendKeys(ConfigReader.getProperty("dean_password"));
        // Kullanici mavi renkli Login butonuna tiklar
        schoolPage06Obj.blueLoginButton.click();
